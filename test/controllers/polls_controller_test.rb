...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { slug: @poll.slug, title: @poll.title, user_id: @poll.user_id } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { slug: @poll.slug, title: @poll.title, user_id: @poll.user_id } }
